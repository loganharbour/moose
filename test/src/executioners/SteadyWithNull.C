...
// {
//   Steady::init();
//   NumericVector<Number> * to_vector1 =
//   &_problem.getNonlinearSystemBase().getVector("NullSpace_0"); const NumericVector<Number> *
//   from_vector = _problem.getAuxiliarySystem().currentSolution(); *to_vector1 = *from_vector; if
//   (_problem.subspaceDim("TransposeNullSpace") > 0)
//   {
