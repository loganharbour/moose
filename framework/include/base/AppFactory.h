...
public:
  ...
  /**
   * Gets the names of the registered applications whose parameters are
   * constructed using the legacy input parameter construction.
   *
   * Needed until #19439 is closed.
   */
  std::set<std::string> getLegacyConstructedApps() const;
