...
protected:
   ...
   */
  void requiresConsumerModes(const ReporterStateBase & state, const std::set<ReporterMode> & modes);
...
protected:
  ...
  virtual std::string contextType() const override { return MooseUtils::prettyCppType<T>(); }
